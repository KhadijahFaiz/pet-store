					    ...
					    <div class="services-box p-2 mb-3">
					      	...
					      	<div class="service-text">
						        ...
						        <?php if(get_the_excerpt()) { ?>
						            <p><?php $pet_animal_store_excerpt = get_the_excerpt(); echo esc_html( pet_animal_store_string_limit_words( $pet_animal_store_excerpt, esc_attr(get_theme_mod('pet_animal_store_related_post_excerpt_number','20')))); ?><?php echo esc_html( get_theme_mod('pet_animal_store_button_excerpt_suffix','[...]') ); ?></p>
						        <?php }?>
