...
* Resolved error for widget content alignment.
...
* Resolved css error for edge case many categories.
* update pot file.
...
* Update POT file.
* Added css for search in topbar.
...
* Resolved css error for my account page anchor.
* Update POT file.

= 1.1.7 =
* Resolved trac ticket error.
...
* Added show/Hide option for Header social icons.
...
* Added font size options in header social icons section.
